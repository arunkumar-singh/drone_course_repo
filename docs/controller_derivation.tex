...
\title{\textbf{\Huge Perception and Control for Drones}\\[0.5em]
\Large Mathematical Modeling and High-Precision Cascaded PID Controller Derivation for a 6-DOF Quadrotor}
